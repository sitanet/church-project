"""
Django settings for dcitygate project.
...
ALLOWED_HOSTS = ['hidden-crag-78820.herokuapp.com']
...
WSGI_APPLICATION = 'dcitygate.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'dcitygate/static'),
]
